...
import { getCompareItems, clearCompareItems } from '../utils/compare.js';
      ...
      <div className="mx-auto max-w-6xl bg-white rounded-3xl p-8 shadow-xl">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-8">
          <div>
            ...
            <p className="text-slate-600 mt-2">Items added to the compare list will appear in separate columns below.</p>
          </div>
        ...
        {items.length === 0 ? (
          <div className="rounded-3xl border border-dashed border-slate-300 p-12 text-center text-slate-600">
            No products in your compare list yet.
          </div>
        ) : (
