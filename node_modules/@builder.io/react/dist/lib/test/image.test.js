...
describe('Image', function () {
    ...
    it('prepends auto to sizes for lazy-loaded images', function () {
        var tree = reactTestRenderer
            .create(React.createElement(Image_1.Image, { image: "https://cdn.builder.io/api/v1/image/assets%2Fabc%2F123?width=500", builderBlock: {
                id: 'test-block',
                responsiveStyles: { large: { width: '50%' } },
            } }))
            .toJSON();
        var picture = tree;
        var img = picture.children.find(function (c) { return c.type === 'img'; });
    ...
    it('does not prepend auto when highPriority (eager) is set', function () {
        var tree = reactTestRenderer
            .create(React.createElement(Image_1.Image, { image: "https://cdn.builder.io/api/v1/image/assets%2Fabc%2F123?width=500", highPriority: true, builderBlock: {
                id: 'test-block',
                responsiveStyles: { large: { width: '50%' } },
            } }))
            .toJSON();
    ...
    it('passes sizes to the webp source tag', function () {
        var tree = reactTestRenderer
            .create(React.createElement(Image_1.Image, { image: "https://cdn.builder.io/api/v1/image/assets%2Fabc%2F123?width=500", builderBlock: {
                id: 'test-block',
                responsiveStyles: { large: { width: '50%' } },
            ...
            .toJSON();
        var picture = tree;
        var source = picture.children.find(function (c) { return c.type === 'source'; });
