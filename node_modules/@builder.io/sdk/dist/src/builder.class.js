...
var Builder = /** @class */ (function () {
    function Builder(apiKey, request, response, forceNewInstance, authToken, apiVersion) {
        ...
        this.contentId$ = new observable_class_1.BehaviorSubject(null);
        ...
        var promise = this.makeFetchApiCall(url, fetchOptions)
            ...
            for (var _i = 0, queue_3 = queue; _i < queue_3.length; _i++) {
                ...
                if (result.totalCount !== undefined) {
                    _this.totalCountByKey[keyName] = result.totalCount;
                }
    ...
    Builder.prototype.getAll = function (modelName, options) {
        ...
        var key = options.key || Builder.isBrowser || options.fetchTotalCount
            ? "".concat(modelName, ":").concat((0, hash_sum_1.default)((0, omit_function_1.omit)(options, 'initialContent', 'req', 'res')))
            : undefined;
        return instance
            .getContent(modelName, __assign(__assign({ limit: 30 }, options), { key: key }))
            .promise()
            ...
            if (options.fetchTotalCount) {
                return {
                    results: results,
                    totalCount: key !== undefined ? (_a = instance.totalCountByKey[key]) !== null && _a !== void 0 ? _a : 0 : 0,
                };
            }
            return results;
        });
