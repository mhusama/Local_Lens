        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    result = _a.sent();
                    expect(builder['makeFetchApiCall']).toBeCalledTimes(1);
                    expect(builder['makeFetchApiCall']).toBeCalledWith("https://cdn.builder.io/api/v3/content/".concat(expectedModel, "?omit=data.blocks&apiKey=").concat(API_KEY, "&fields=data&format=").concat(expectedFormat, "&userAttributes=%7B%22urlPath%22%3A%22%2F%22%2C%22host%22%3A%22localhost%22%2C%22device%22%3A%22desktop%22%7D&includeRefs=true&limit=10&model=%22").concat(expectedModel, "%22&entry=%22123%22&query.id=%22").concat(expectedEntryId, "%22"), { headers: { Authorization: "Bearer ".concat(AUTH_TOKEN) } });
                    return [2 /*return*/];
            }
        });
    }); });
    test('hits content url with query as the same object as the one passed in options.query if query contains $ mongo-operator', function () { return __awaiter(void 0, void 0, void 0, function () {
        var expectedModel, expectedFormat, expectedEntryId, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    result = _a.sent();
                    expect(builder['makeFetchApiCall']).toBeCalledTimes(1);
                    expect(builder['makeFetchApiCall']).toBeCalledWith("https://cdn.builder.io/api/v3/content/symbol?omit=data.blocks&apiKey=25608a566fbb654ea959c1b1729e370d&fields=data&format=email&userAttributes=%7B%22urlPath%22%3A%22%2F%22%2C%22host%22%3A%22localhost%22%2C%22device%22%3A%22desktop%22%7D&includeRefs=true&limit=10&model=%22symbol%22&entry=%22123%22&query.data.sourceUrl=%7B%22%24eq%22%3A%22%2Fc%2Fdocs%2Fdevelop%22%7D", { headers: { Authorization: "Bearer ".concat(AUTH_TOKEN) } });
                    return [2 /*return*/];
            }
        });
    }); });
    test('hits content url with query as the flattened object as the one passed in options.query if query does not contain $ mongo-operator', function () { return __awaiter(void 0, void 0, void 0, function () {
        var expectedModel, expectedFormat, expectedEntryId, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    result = _a.sent();
                    expect(builder['makeFetchApiCall']).toBeCalledTimes(1);
                    expect(builder['makeFetchApiCall']).toBeCalledWith("https://cdn.builder.io/api/v3/content/symbol?omit=data.blocks&apiKey=25608a566fbb654ea959c1b1729e370d&fields=data&format=email&userAttributes=%7B%22urlPath%22%3A%22%2F%22%2C%22host%22%3A%22localhost%22%2C%22device%22%3A%22desktop%22%7D&includeRefs=true&limit=10&model=%22symbol%22&entry=%22123%22&query.data.sourceUrl=%22%2Fc%2Fdocs%2Fdevelop%22&query.name.fullName=%22John%20Doe%22", { headers: { Authorization: "Bearer ".concat(AUTH_TOKEN) } });
                    return [2 /*return*/];
            }
        });
    }); });
...
describe('get', function () {
    ...
    test('hits content API with locale=en-IN added to the locale query param and the userAttributes.locale param', function () { return __awaiter(void 0, void 0, void 0, function () {
        var expectedModel, expectedLocale;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    expectedModel = 'page';
                    expectedLocale = 'en-IN';
                    builder.apiEndpoint = 'content';
                    return [4 /*yield*/, builder.get(expectedModel, { locale: expectedLocale })];
                case 1:
                    _a.sent();
                    expect(builder['makeFetchApiCall']).toBeCalledTimes(1);
                    expect(builder['makeFetchApiCall']).toBeCalledWith("https://cdn.builder.io/api/v3/content/page?omit=meta.componentsUsed&apiKey=".concat(API_KEY, "&locale=").concat(expectedLocale, "&noTraverse=false&userAttributes=%7B%22locale%22%3A%22").concat(expectedLocale, "%22%7D&includeRefs=true&model=%22").concat(expectedModel, "%22"), { headers: { Authorization: "Bearer ".concat(AUTH_TOKEN) } });
                    return [2 /*return*/];
            }
        });
    }); });
...
describe('getAll', function () {
    ...
    test('hits content API with locale=en-IN added to the locale query param and NOT the userAttributes.locale param', function () { return __awaiter(void 0, void 0, void 0, function () {
        var expectedModel, expectedLocale;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    expectedLocale = 'en-IN';
                    builder.apiEndpoint = 'content';
                    return [4 /*yield*/, builder.getAll(expectedModel, { locale: expectedLocale })];
                case 1:
                    _a.sent();
                    expect(builder['makeFetchApiCall']).toBeCalledTimes(1);
                    expect(builder['makeFetchApiCall']).toBeCalledWith("https://cdn.builder.io/api/v3/content/page?omit=meta.componentsUsed&apiKey=".concat(API_KEY, "&locale=").concat(expectedLocale, "&noTraverse=true&userAttributes=%7B%22urlPath%22%3A%22%2F%22%2C%22host%22%3A%22localhost%22%2C%22device%22%3A%22desktop%22%7D&includeRefs=true&limit=30&model=%22").concat(expectedModel, "%22"), { headers: { Authorization: "Bearer ".concat(AUTH_TOKEN) } });
                    return [2 /*return*/];
            }
        });
    }); });
    test('hits query url with enrich=true when passed in options', function () { return __awaiter(void 0, void 0, void 0, function () {
        var expectedModel;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    expectedModel = 'page';
                    return [4 /*yield*/, builder.getAll(expectedModel, { enrich: true })];
                case 1:
                    _a.sent();
                    expect(builder['makeFetchApiCall']).toBeCalledTimes(1);
                    expect(builder['makeFetchApiCall']).toBeCalledWith(expect.stringContaining('enrich=true'), expect.anything());
                    return [2 /*return*/];
            }
        });
    }); });
    test('hits query url with enrichOptions.enrichLevel when passed in options', function () { return __awaiter(void 0, void 0, void 0, function () {
        var expectedModel;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    expect(builder['makeFetchApiCall']).toBeCalledWith(expect.stringContaining('enrich=true'), {
                        headers: { Authorization: "Bearer ".concat(AUTH_TOKEN) },
                    });
                    expect(builder['makeFetchApiCall']).toBeCalledWith(expect.stringContaining('enrichOptions.enrichLevel=2'), { headers: { Authorization: "Bearer ".concat(AUTH_TOKEN) } });
                    return [2 /*return*/];
            }
        });
    }); });
    test('hits content url with enrich=true when apiEndpoint is content', function () { return __awaiter(void 0, void 0, void 0, function () {
        var expectedModel;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    test('hits content url with enrichOptions.enrichLevel when apiEndpoint is content', function () { return __awaiter(void 0, void 0, void 0, function () {
        var expectedModel;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    expect(builder['makeFetchApiCall']).toBeCalledWith(expect.stringContaining('enrichOptions.enrichLevel=3'), { headers: { Authorization: "Bearer ".concat(AUTH_TOKEN) } });
                    return [2 /*return*/];
            }
        });
    }); });
    test('hits query url with enrichOptions.model when passed complex model options', function () { return __awaiter(void 0, void 0, void 0, function () {
        var expectedModel;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    expect(builder['makeFetchApiCall']).toBeCalledTimes(1);
                    expect(builder['makeFetchApiCall']).toBeCalledWith(expect.stringContaining('enrichOptions.enrichLevel=2'), { headers: { Authorization: "Bearer ".concat(AUTH_TOKEN) } });
                    expect(builder['makeFetchApiCall']).toBeCalledWith(expect.stringContaining('enrichOptions.model.product.fields=id%2Cname%2Cprice'), { headers: { Authorization: "Bearer ".concat(AUTH_TOKEN) } });
                    expect(builder['makeFetchApiCall']).toBeCalledWith(expect.stringContaining('enrichOptions.model.product.omit=data.internalNotes'), { headers: { Authorization: "Bearer ".concat(AUTH_TOKEN) } });
                    expect(builder['makeFetchApiCall']).toBeCalledWith(expect.stringContaining('enrichOptions.model.category.fields=id%2Cname'), { headers: { Authorization: "Bearer ".concat(AUTH_TOKEN) } });
                    return [2 /*return*/];
            }
        });
    }); });
    test('includes fetchTotalCount=true in URL when option is set', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    builder.apiEndpoint = 'content';
                    return [4 /*yield*/, builder.getAll('blog-post', { fetchTotalCount: true })];
                case 1:
                    _a.sent();
                    expect(builder['makeFetchApiCall']).toBeCalledWith(expect.stringContaining('fetchTotalCount=true'), expect.anything());
                    return [2 /*return*/];
            }
        });
    }); });
    test('does not include fetchTotalCount in URL when option is not set', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    builder.apiEndpoint = 'content';
                    return [4 /*yield*/, builder.getAll('blog-post', {})];
                case 1:
                    _a.sent();
                    expect(builder['makeFetchApiCall']).not.toBeCalledWith(expect.stringContaining('fetchTotalCount'), expect.anything());
                    return [2 /*return*/];
            }
        });
    }); });
    test('resolves to { results, totalCount } when fetchTotalCount is true', function () { return __awaiter(void 0, void 0, void 0, function () {
        var mockResults, mockTotalCount, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockResults = [{ id: 'abc', data: {} }];
                    mockTotalCount = 99;
                    builder['makeFetchApiCall'] = jest.fn(function () {
                        return Promise.resolve({
                            json: function () { return Promise.resolve({ results: mockResults, totalCount: mockTotalCount }); },
                        });
                    });
                    builder.apiEndpoint = 'content';
                    return [4 /*yield*/, builder.getAll('blog-post', { fetchTotalCount: true })];
    ...
    test('resolves to BuilderContent[] (not wrapped) when fetchTotalCount is not set', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    builder['makeFetchApiCall'] = jest.fn(function () {
                        return Promise.resolve({
                            json: function () { return Promise.resolve({ results: mockResults }); },
                        });
                    });
                    builder.apiEndpoint = 'content';
                    return [4 /*yield*/, builder.getAll('blog-post', {})];
