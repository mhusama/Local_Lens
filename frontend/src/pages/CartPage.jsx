...
import { getCartItems, clearCartItems } from '../utils/cart.js';
      ...
      <div className="mx-auto max-w-6xl bg-white rounded-3xl p-8 shadow-xl">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-8">
          <div>
            ...
            <p className="text-slate-600 mt-2">All items added to your cart are listed here.</p>
          </div>
        ...
        {items.length === 0 ? (
          ...
          <div className="overflow-x-auto">
            ...
            <div className="mt-8 flex justify-end rounded-3xl bg-slate-50 p-6 text-right">
              <div>
