...
var ImageComponent = /** @class */ (function (_super) {
    ...
    ImageComponent.prototype.render = function () {
        ...
        var sizesComputed = (0, exports.getSizes)(this.props.sizes, builderBlock, ((_b = (_a = builderState === null || builderState === void 0 ? void 0 : builderState.context.builderContent) === null || _a === void 0 ? void 0 : _a.meta) === null || _b === void 0 ? void 0 : _b.breakpoints) || {});
        // Prepend "auto" only for auto-calculated sizes on lazy-loaded images so
        // browsers that support it use the rendered width.
        var shouldPrependAuto = !this.props.sizes && !this.loadEagerly;
        var sizes = shouldPrependAuto ? "auto, ".concat(sizesComputed) : sizesComputed;
        ...
        return ((0, core_1.jsx)(builder_meta_1.BuilderMetaContext.Consumer, null, function (value) {
            ...
            return ((0, core_1.jsx)(react_1.default.Fragment, null,
                amp ? (imageContents) : ((0, core_1.jsx)("picture", { ref: function (ref) { return (_this.pictureRef = ref); } },
                    srcset && srcset.match(/builder\.io/) && !_this.props.noWebp && ((0, core_1.jsx)("source", { srcSet: srcset.replace(/\?/g, '?format=webp&'), type: "image/webp", sizes: sizes || undefined })),
                    imageContents)),
